...
# ==========================================
# 3. قاموس المصطلحات لتدعيم اللغتين (تم نقله هنا لتفادي الخطأ)
# ==========================================
text = {
    "ar": {
        ...
        "analysis": "تحليل البيانات والمشهاد",
...
On Sun, Jul 19, 2026, 1:28 AM نهله محمد علي <nahalah135@gmail.com> wrote:
import streamlit as st
import pandas as pd
import plotly.express as px
from gtts import gTTS
...
On Sun, Jul 19, 2026, 1:09 AM نهله محمد علي <nahalah135@gmail.com> wrote:
streamlit
pandas
plotly
gTTS

On Sun, Jul 19, 2026, 1:07 AM نهله محمد علي <nahalah135@gmail.com> wrote:
import streamlit as st
import pandas as pd
import plotly.express as px
from gtts import gTTS
